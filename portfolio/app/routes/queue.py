...
def queue_home():
    ...
    validation_type_q = session.get('validation_type_q', None)  # Initialize validation type
    ...
    if request.method == 'POST':
        ...
        if action == 'toggle_queue':  # Toggle between normal queue and double-ended queue
            ...
            session['validation_type_q'] = validation_type_q
        ...
        # Set the validation string and validation type save to session
        session['validation_string'] = validation_string
        session['validation_type_q'] = validation_type_q
    ...
    return render_template(
        ...
        validation_type_q = validation_type_q,
